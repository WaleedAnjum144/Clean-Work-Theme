...
<main>
    ...
    <section class="banner-section d-flex justify-content-center align-items-end">
        ...
        <div class="backstretch banner">
            ...
            <img
                src="<?php echo get_template_directory_uri(); ?>/images/slideshow/unrecognizable-cleaner-walking-into-hotel-room-with-tools-detergents.jpg">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <form class="custom-form consulting-form bg-white shadow-lg mb-5 mb-lg-0" action="#" method="post"
                        role="form">
